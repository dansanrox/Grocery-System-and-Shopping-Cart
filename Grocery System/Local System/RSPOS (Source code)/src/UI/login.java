...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Rajaguru Stores | Login");
    ...
    public void sve() {
        try {
            ...
            ResultSet record = con.executeQuery("SELECT username,password,accesslevel FROM system_login WHERE username='" + loginusername.getText() + "'");
            while (record.next()) {
                un = record.getString("username");
                pw = record.getString("password");
                al = record.getString("accesslevel");
